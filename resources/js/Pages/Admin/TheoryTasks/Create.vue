...
const props = defineProps({
    ...
    // back link can point at the lesson edit page.
...
const form = useForm({
    ...
    is_published: false,
    options: [
        { text: '', is_correct: true, error_text: '' },
        { text: '', is_correct: false, error_text: '' },
    ],
});
...
const submit = () => {
    ...
    form.transform((data) => {
        ...
        return payload;
    }).post(`/admin/lessons/${props.lesson.id}/theory-tasks`);
};
</script>
...
<template>
    <AdminLayout>
        ...
        <h1 class="text-2xl font-semibold text-gray-900 mb-2">Новое теоретическое задание</h1>
