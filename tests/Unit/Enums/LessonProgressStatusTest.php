...
class LessonProgressStatusTest extends TestCase
{
    public function test_in_progress_case_returns_string_value(): void
    {
        $this->assertSame('InProgress', LessonProgressStatus::InProgress->value);
    }

    public function test_in_progress_case_returns_human_label(): void
    {
        $this->assertSame('В процессе', LessonProgressStatus::InProgress->label());
    }

    public function test_completed_case_returns_string_value(): void
    {
        $this->assertSame('Completed', LessonProgressStatus::Completed->value);
    }

    public function test_completed_case_returns_human_label(): void
    {
        $this->assertSame('Пройден', LessonProgressStatus::Completed->label());
    }

    public function test_it_has_two_cases(): void
    {
        $this->assertCount(2, LessonProgressStatus::cases());
    }
